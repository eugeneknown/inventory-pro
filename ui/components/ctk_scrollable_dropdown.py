"""
CTkScrollableDropdown - Advanced Scrollable Dropdown for customtkinter
Author: Akash Bora (Akascape)
Source: https://github.com/Akascape/CTkScrollableDropdown
Vendored locally for InventoryPro to avoid external pip dependency.
"""
...
class CTkScrollableDropdown(customtkinter.CTkToplevel):
    ...
    def __init__(self, attach, x=None, y=None, button_color=None, height: int = 200, width: int = None,
                 fg_color=None, button_height: int = 28, justify="left", scrollbar_button_color=None,
                 scrollbar=True, scrollbar_button_hover_color=None, frame_border_width=2, values=[],
                 command=None, image_values=[], alpha: float = 0.97, frame_corner_radius=12, double_click=False,
        ...
        # Binding for different ctk widgets
